...
$(document).ready(function() {
	 $('#sourceTable').submit(function(e) {
	  ...
	  $('#destinationTable').submit(function(e) {
	   ...
	   /*  if (Dpassword !="") {
	      $('#Dpassword').after('<span class="error">Invalid Password</span>');
	      count=1;
	    } */
	    if(count==0)
	    	{
...
<div class="span6">
	...
	<form:form id="destinationTable" modelAttribute="destination" name="destinationconnection">
			<h1 align="center">Destination</h1>
			<div class="form-group">
				<label for="driverName">DRIVER NAME</label> <input type="text"
					class="form-control" name="driverName" id="DdriverName" class="form-group"/>
			</div>
			<div class="form-group">
